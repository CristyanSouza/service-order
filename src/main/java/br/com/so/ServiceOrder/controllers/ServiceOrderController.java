...
public class ServiceOrderController {
	...
	@PutMapping
	public ResponseEntity<ServiceOrderDTO> update(@Valid @RequestBody ServiceOrderDTO so){
		
		ServiceOrderDTO soDto = soService.update(so);
		
		return ResponseEntity.ok().body(soDto);
	}
